                            ...
                            <VStack space="20px">
                                ...
                                <FormControl isRequired isInvalid={'password_confirmation' in errors}>
                                    <Controller
                                        control={control}
                                        render={({ field: { onChange, onBlur, value } }) => (
                                            <Input onChangeText={(val) => onChange(val)} type="password" leftElement={<Icon as={<Ionicons name="lock-closed-outline" />} size={5} ml="2" color="primary.text" />} w={'100%'} placeholder={event.labels.CONFIRM_PASSWORD} />
                                        )}
