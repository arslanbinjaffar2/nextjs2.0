...
const Detail = () => {
    ...
    const [tab, setTab] = React.useState<'popular' | 'recent' | 'archive' | 'my_questions'>('popular')
    ...
    const TabHeadings: any = {
        ...
        my_questions: labels?.HD_MY_QUESTIONS ?? 'My Questions',
    };
    ...
    const updateQuestionsCount = (tab: string) => {
        switch (tab) {
            ...
            case 'archive':
                ...
                break;
            case 'my_questions':
                setQuestionsCount(hdDetails?.my_questions?.length ?? 0);
                break;
            default:
                setQuestionsCount(0);
                break;
                                    ...
                                    <Box mb="10" px="3" w="100%" position="relative">
                                        ...
                                        {!loading && <>
                                            <VStack w="100%" space="3">
                                                ...
                                                {tab === 'my_questions' && hdDetails?.my_questions.length <= 0 &&
                                                    <NoRecordFound bg="primary.box" />
                                                }
                                            </VStack>
                                        </>
