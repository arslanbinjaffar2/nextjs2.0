      ...
      >
        <Box pt={6} px={[3, 6]} pb={4} w={'100%'}>
          <Box w={'100%'} position={'relative'} alignItems={'center'}>
            {setting_modules &&
              setting_modules?.find(
                (module) => module?.alias == 'editprofile'
              ) && (
                <Button
                  position={'absolute'}
                  right={0}
                  ...
                  leftIcon={
                    <DynamicIcon
                      ...
                      iconProps={{
                        width: 16,
                        height: 16,
                        color: func.colorType(event?.settings?.primary_color)
                          ? func.colorType(event?.settings?.primary_color)
                          : undefined,
                      }}
                    />
                  }
            ...
            {response?.data?.user?.sort_field_setting?.map((item: any) => {
              return (
                <>
                  {item.name === 'email' && (
                    <Center mb={2}>
                      {response?.attendee_detail &&
                        response?.attendee_detail?.email && (
                  ...
                  {item.name === 'phone' && (
                    <Center mb={2}>
                      {response?.data?.user &&
                        response?.attendee_detail?.phone && (
                          <HStack space="2" alignItems="center">
        ...
        {response?.data?.user?.sort_field_setting?.map((item: any) => {
          return (
            <>
              ...
              {item.name === 'bio_info' &&
                response?.attendee_detail?.detail?.about && (
                  <Box w={'100%'}>
                    <Box mb={5} px={5} py={1} bg="primary.darkbox">
                      <Text fontSize="md">
                        {response.event?.labels?.REG_BASIC_INFO}
                      </Text>
                    </Box>
                    ...
                    >
                      <Text
                        ...
                        color={'primary.text'}
                      >
                        {response.event?.labels?.ATTENDEE_ABOUT}
                      </Text>
                      <Text>
                        <RenderHtml
                          ...
                          source={{
                            html: response?.attendee_detail?.detail?.about,
                          }}
                        />
                      </Text>
                    </HStack>
            ...
            return (
              <>
                ...
                {item.name === 'date_of_issue_passport' &&
                  response?.attendee_detail?.detail?.date_of_issue_passport && (
                    <HStack
                      w={['100%', '50%']}
                      mb={4}
                      alignItems="center"
                ...
                {item.name === 'pa_country' &&
                  response?.attendee_detail?.detail?.private_country_name && (
                    <HStack
                      w={['100%', '50%']}
                      mb={4}
                      alignItems="center"
                ...
                {item.name === 'pa_house_no' &&
                  response?.attendee_detail?.detail?.private_house_number && (
                    <HStack
                      w={['100%', '50%']}
                      mb={4}
                      alignItems="center"
                          ...
                          {item.is_private === 0 ? (
                            <HStack
                              ...
                              flexDirection={[
                                'column',
                                width <= 1024 ||
                                response?.attendee_detail?.attendee_cv.length <
                                  50
                                  ? 'column'
                                  : 'row',
                              ]}
                            >
                              ...
                              >
                                {response?.attendee_detail?.attendee_cv.replace(
                                  /[0-9_]/g,
                                  ''
                                )}
                              </Text>
