                ...
                in_array('poll-listing', processing) ? (
                    ...
                    <Container pt="2" maxW="100%" w="100%">
                        ...
                        <HStack mb="3" space={1} justifyContent="center" w="100%">
                            <Button onPress={() => setTab('pending')} borderWidth="0px" py={0} borderColor="primary.boxbutton" borderRightRadius="0" borderLeftRadius={8} h="42px" bg={tab == 'pending' ? 'primary.boxbutton' : 'primary.box'} w="50%" _text={{ fontWeight: '600' }}>{poll_labels?.NATIVE_APP_SURVEY_NOT_ATTENDED}</Button>
                            <Button isDisabled={pollSettings?.user_settings == 1 ? false:true } onPress={() => setTab('completed')} borderWidth="0px" py={0} color="primary.100" borderColor="primary.boxbutton" borderLeftRadius="0" borderRightRadius={8} h="42px" bg={tab == 'completed' ? 'primary.boxbutton' : 'primary.box'} w="50%" _text={{ fontWeight: '600' }}>{poll_labels?.NATIVE_APP_SURVEY_COMPLETED}</Button>
                        </HStack>
                        {tab === 'pending' &&  (
