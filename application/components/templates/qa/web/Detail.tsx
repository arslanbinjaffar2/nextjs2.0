...
const Detail = () => {
    ...
    const onSubmit = () => {
        ...
        const paragraphData = qaDetials.paragraph.length > 0 ? pg?.heading : paragraph;
        ...
        const postData = {
            ...
            agenda_id: id,
            paragraph_id: pg?.id,
            paragraph_number: paragraphData,
                        ...
                        <Container overflow="hidden" mb="4" maxW="100%" w="100%">
                            <Box overflow="hidden" w="100%" bg="primary.box" p="0" rounded="10px" >
                                ...
                                <Box w="100%">
                                    ...
                                    {qaSettings?.paragraph_number === 1 && <HStack px="3" w="100%" borderBottomWidth={1} borderBottomColor={'primary.bordercolor'} pb={'3'} mb="3" alignItems="center">
