            ...
            {post.attendee.id === response?.data?.user?.id && (
              <HStack px={3} w={'100%'} justifyContent={'flex-end'} space="3" alignItems="center">
                ...
                >
                  ...
                  <Menu.Item _text={{color: 'primary.boxsolidtext'}} _focus={{ bg: '' }} _hover={{ bg: 'primary.500' }} onPress={() => { deletePost() }}>Delete</Menu.Item>
                </Menu>
              </HStack>
                ...
                <Popover.Body bg={'primary.boxsolid'} borderTopWidth="0" p={0} rounded={6}>
                  <Box bg={'primary.boxsolid'} py={3} borderWidth="0" borderColor="primary.box">
                    <HStack width={'100%'} px={3} space="1" alignItems="center">
                      ...
                      <Text color={'primary.boxsolidtext'} fontSize="md" fontWeight={500}>  Liked by</Text>
                    </HStack>
