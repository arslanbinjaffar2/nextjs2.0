...
export const AvailabilityModal = ({isOpen, onClose,message,title,AvaiblityID,description}: AvailabilityModalProps) => {
    ...
    onClose()
            ...
            <Modal.Content ref={_element}  bg={'primary.boxsolid'}>
                ...
                <Modal.Header px={5} py={3} bg="primary.boxsolid" borderWidth={0} borderColor={'transparent'}>
                    ...
                    <Text color={'primary.text'} fontSize="24px" fontWeight={'medium'} ml={4}>{title}</Text>
                    </View>
                </Modal.Header>
                <Modal.Body pt={0} bg="primary.boxsolid" px={0}>
                    <Text color={'primary.text'} mb={3} px={5} fontSize="20px" fontWeight={'medium'}>{message}</Text>
                    <Text color={'primary.text'} mb={3} px={5} fontSize="md" fontWeight={'normal'}>{description}</Text>
                </Modal.Body>
