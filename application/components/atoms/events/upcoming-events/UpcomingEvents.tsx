                        ...
                        <View display="flex" flexDirection={['column', 'row']} alignItems="flex-start" width="100%" py="14px" px="16px" bg="primary.box">
                            ...
                            <View display="flex" flexDirection="column" ml={['', '30px']} mt={['14px', '']} w="100%">
                                ...
                                <View flexDirection="row" alignItems="center" mt="3">
                                    {upcoming_event?.not_attending_link &&<Button  width={['100%', '136px']} height={38} onPress={() => window.open(upcoming_event?.not_attending_link, '_blank')}>
                                        <Box display="flex" alignItems="center" flexDirection="row">
                                            <DynamicIcon iconType="Notattending" iconProps={{ width: 14, height: 16, color: 'primary.text' }} />
                                            <Text ml="6px" color={'primary.hovercolor'} >
                                                {event?.labels?.ATTENDEE_UNSUBSCRIBE_TEXT}
                                            </Text>
                                        </Box>
                                    </Button>}
                                    {upcoming_event?.register_link && <Button width={['100%', '136px']} height={38} ml="10px" onPress={() => window.open(upcoming_event?.register_link, '_blank')}>
