...
const Search = ({  w }: AppProps) => {
    ...
    return (
        <Input rounded="10" bg="primary.box" borderWidth={0} 
        borderColor={'transparent'} w={['100%',w ? w : '60%']}  ref={searchInputRef}  placeholder={event?.labels?.GENERAL_SEARCH} leftElement={<Icon ml="2" color="primary.text" size="lg" as={AntDesign} name="search1" />} onChangeText={(text: string) => {
