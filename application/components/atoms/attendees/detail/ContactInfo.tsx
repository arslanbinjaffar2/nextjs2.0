      ...
      <Box p="0" w="100%" bg={'primary.box'} mb={5} rounded={8}>
        ...
        <Box py="0" px="0" w="100%">
          <HStack space={3} p={3} py={2} w={'100%'} justifyContent={'flex-start'} alignItems={'center'} mt={'1'}>
            ...
            {detail?.detail?.info?.facebook  && detail?.sort_field_setting.find(item => item.name === 'facebook') && detail?.detail?.info?.facebook !== '' && detail?.detail?.info?.facebook !== 'http://' &&  detail?.detail?.info?.facebook !== 'https://' ? (
              <Pressable
                onPress={async () => {
