...
import { Box, Container, HStack, Pressable, Icon, Text, VStack } from 'native-base'
  ...
  return (
    <>
      <Box p="0" w="100%" bg={'primary.box'} mb={5} rounded={8}>
        ...
        {(detail?.detail?.email !== '' || detail?.detail?.phone !== '') && <VStack px="3" py="2" w="100%" space="3">
          ...
          {detail?.detail?.phone && detail?.detail?.phone !== '' && <HStack space="0" alignItems="flex-start">
            <Box w="20%">
