...
function* OnFetchGroups({
    ...
    yield put(HdActions.update({ groups: response.data.data.groups!, settings:response.data.data.settings!, labels:response.data.data.labels!}))
...
//             hd_settings:response.data.data.hd_settings!,
