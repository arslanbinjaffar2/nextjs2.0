...
import BackgroundLayout from 'screens/web/layouts/BackgroundLayout';
const Login = ({ navigation }: any) => {
  return (
    <BackgroundLayout>
      <Center w={'100%'} h="100%" alignItems={'center'} px={15}>
        <Flex borderWidth="1px" borderColor="primary.bdColor" maxWidth={'515px'} bg="primary.box" p={{base: '30px', md: '50px'}} w="100%" rounded="10">
