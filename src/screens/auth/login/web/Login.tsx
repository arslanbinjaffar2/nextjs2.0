  ...
  return (
    <BackgroundLayout>
      <Center w={'100%'} h="100%" alignItems={'center'} px={15}>
        <Flex borderWidth="1px" borderColor="primary.bdColor" maxWidth={'515px'} minH="380px" bg="primary.box" p="50px" w="100%" rounded="10">
          <Image alt='logo' mb={10} source={images.Logo} w="180px" h="39px" alignSelf={'center'} />
